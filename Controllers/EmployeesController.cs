...
namespace MVC_Practice.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(MVC_PracticeContext context)
        {
            _context = context;
        }
        ...
        {
            var mVC_PracticeContext = _context.Employee.Include(e => e.Department);
            return View(await mVC_PracticeContext.ToListAsync());
        }
